export type TranslationKey =
  ...
  | 'task.search'
  | 'task.empty'
  | 'taskList.removeConfirmTitle'
  | 'taskList.removeConfirmMessage'
  | 'taskItem.subtask'
  | 'taskItem.hasSubtasks'
  | 'start'
  | 'end'
  | 'not_set'
  | 'not_started'
  ...
  | 'statistics.streak_message'
  | 'statistics.start_streak_message'
  | 'statistics.empty'
  | 'statistics.last_updated'
  | 'statistics.no_data'
  | 'statistics.no_category_data'
  | 'statistics.no_priority_data'
  ...
  | 'category.deleteError'
  | 'tag.deleteConfirmTitle'
  | 'tag.deleteConfirmMessage'
  | 'project.deleteConfirmTitle'
  | 'project.deleteConfirmMessage'
  | 'taskDetail.deleteSuccess'
