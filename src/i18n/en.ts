...
const en: Translations = {
  ...
  'statistics.progress': 'Task Progress',
  'statistics.by_category': 'Tasks by Category',
  'statistics.by_priority': 'Tasks by Priority',
  'statistics.streak': 'Completion Streak',
  'statistics.current_streak': 'Current',
  'statistics.longest_streak': 'Longest',
  'statistics.empty': 'No statistics data available',
  'statistics.last_updated': 'Last updated',
  'statistics.streak_message': 'You have completed tasks for {{count}} days in a row!',
  'statistics.start_streak_message': 'Complete a task today to start a new streak!',
  'statistics.no_data': 'No task data available',
  'statistics.no_category_data': 'No category data available',
  'statistics.no_priority_data': 'No priority data available',
 ...
 'taskList.searchAccessibilityLabel': 'Search tasks',
  ...
  'backup.exportError': 'Could not export data',
  'backup.importSuccess': 'Data imported successfully',
  'backup.importError': 'Could not import data',
  'backup.importConfirmTitle': 'Confirm Import',
  'backup.importConfirmMessage': 'Are you sure you want to import this data? Current data will be replaced.',
  'backup.exportInfo': 'Export your data to a JSON file that you can use to restore your tasks later.',
  'backup.importWarning': 'Warning: Importing data will replace all your current data. Make sure to backup first.',
  'backup.exportButton': 'Export Data',
  'backup.importButton': 'Import Data',
  'backup.shareButton': 'Share Backup',
  'backup.loading': 'Processing...',
  'backup.invalidFileFormat': 'Invalid file format. Please select a valid JSON backup file.',
  'backup.noExportFile': 'No export file available. Please export data first.',
  'backup.shareNotImplemented': 'Share functionality not implemented yet',
  'backup.findExportAt': 'Your export file is located at',
  'backup.lookInDirectory': 'Look for backup files in',
  'settings.data.backup': 'Backup & Restore',
